...
import { Search, MapPin, MessageSquare, X, Briefcase, GraduationCap, Globe, Languages } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-gray-900/50 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl p-6 relative max-h-[90vh] overflow-auto">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900">{viewing.user.name}</h3>
